...
Secrets (SSH keys, client certs, Discord webhook URL) are mounted as files or passed as env vars; the database stores only references, never the secret material.
